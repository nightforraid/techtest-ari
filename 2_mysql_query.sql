...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 02, 2023 at 05:23 AM
...
(4, 20190004, 'Sari', 2019),
(5, 20190004, 'Bambang', 2019);
...
--
ALTER TABLE `tb_mahasiswa`
  MODIFY `mhs_id` int(12) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `tb_mahasiswa_nilai`
--
ALTER TABLE `tb_mahasiswa_nilai`
  MODIFY `mhs_nilai_id` int(12) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
